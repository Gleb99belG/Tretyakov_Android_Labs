...
public class MainView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        //Обновите экран, если анимация не активна
        if (game.aGrid.isAnimationActive()) {
            invalidate(startingX, startingY, endingX, endingY);
            tick();
            //Обновление в последний раз в конце игры.
    ...
    //Визуализирует набор из 16 фоновых квадратов.
            ...
            for (int yy = 0; yy < game.numSquaresY; yy++) {
                ...
                if (currentTile != null) {
                    ...
                    for (int i = aArray.size() - 1; i >= 0; i--) {
                        ...
                        //Если эта анимация неактивна,то пропустить
                        ...
                        if (aCell.getAnimationType() == MainGame.SPAWN_ANIMATION) { //Анимация появления
                        ...
                        } else if (aCell.getAnimationType() == MainGame.MERGE_ANIMATION) { // Слияние анимации
                            double percentDone = aCell.getPercentageDone();
                            ...
                            bitmapCell[index].setBounds((int) (sX + cellScaleSize), (int) (sY + cellScaleSize), (int) (eX - cellScaleSize), (int) (eY - cellScaleSize));
                            bitmapCell[index].draw(canvas);
                        } else if (aCell.getAnimationType() == MainGame.MOVE_ANIMATION) {  // Движение анимации
                            double percentDone = aCell.getPercentageDone();
                            int tempIndex = index;
                            if (aArray.size() >= 2) {
