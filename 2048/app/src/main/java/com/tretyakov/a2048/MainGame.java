...
public class MainGame {
    ...
    //Нечетное состояние - игра не активна
    //Четное состояние - игра активна
    //Состояние победы = активное состояние + 1
            ...
            for (int yy : traversalsY) {
                ...
                if (tile != null) {
                    ...
                    if (next != null && next.getValue() == tile.getValue() && next.getMergedFrom() == null) {
                        ...
                        // Совмещение позиций двух клеток
                        ...
                        if (merged.getValue() >= winValue() && !gameWon()) {
                            gameState = gameState + GAME_WIN; // Состояние победы
                            endGame();
                        }
                    } else {
